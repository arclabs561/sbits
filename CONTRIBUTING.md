# Contributing to sbits

Thanks for your interest. sbits is succinct data structures: near-optimal space with efficient queries.
...
- Commit messages: `sbits: short lowercase description`. One commit per logical change.
